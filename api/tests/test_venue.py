...
def test_create_venue():
    ...
    expected = {
        "venue_id": 1,
        "venue_name": TEST_VENUE["venue_name"],
        "address": TEST_VENUE["address"],
        "category": TEST_VENUE["category"],
        "description": TEST_VENUE["description"],
    }
...
def test_update_venue():
    ...
    actual = response.json()
    expected = {
        "venue_name": TEST_2_VENUE["venue_name"],
        "address": TEST_2_VENUE["address"],
        "category": TEST_2_VENUE["category"],
        "description": TEST_2_VENUE["description"],
    }
    expected = {"venue_id": 1, **expected}
    assert actual == expected
